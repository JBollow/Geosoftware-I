...
function BuildArray(input) {
    ...
    this.work = function (input) {
        ...
        coordArray = coordArray.filter(function (entry) {
            return entry.trim() != '';
        }); // trimming the whitespaces from the array, after using them to split the String into the array
